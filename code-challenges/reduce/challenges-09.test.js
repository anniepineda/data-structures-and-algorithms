...
const countNumberOfElements = (arr) => {
  return arr.reduce(numOfElements => numOfElements + 1, 0);
};
...
const reversedString = (str) => {
  let arr = str.split('').reduce((str, reverseOrder)=> {
    return reverseOrder + str;
  });
  return arr;
};
...
const calculateAverage = (arr) => {
  ...
  return arrayAverage.sum / arrayAverage.count;
};
